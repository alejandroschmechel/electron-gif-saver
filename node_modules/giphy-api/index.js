...
*/
var GIPHY_API_HOSTNAME = 'api.giphy.com';
/**
* Hostname of the Giphy upload API
*/
var GIPHY_UPLOAD_API_HOSTNAME = 'upload.giphy.com';
/**
...
GiphyAPI.prototype = {
    ...
    */
    _request: function(options, callback) {
        ...
        var requestOptions = {
            hostname: options.hostname ? options.hostname : GIPHY_API_HOSTNAME,
        ...
        var makeRequest = function(resolve, reject) {
            var req = self.httpService.request(requestOptions, function(response) {
                var body = '';
